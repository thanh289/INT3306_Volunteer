...
export const EventActions = ({
  ...
  return (
    <div className="bg-base-100 rounded-2xl shadow-md border-2 border-error">
      <div className="p-6 border-b border-error/30">
        <h2 className="text-xl font-bold text-error">Hành động nguy hiểm</h2>
      </div>
          ...
          {(isCreator || isAdmin) && (
            <div className="flex items-start gap-4 p-4 bg-base-100 rounded-lg border border-base-300">
              <div className="flex-1">
                ...
                <p className="text-sm text-base-content/70">
                  Xóa hoàn toàn sự kiện và tất cả dữ liệu liên quan. Hành động
