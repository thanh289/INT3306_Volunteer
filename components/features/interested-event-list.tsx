        ...
        <div className="card-body p-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold">
              {filteredEvents.length === data.interestedEvents.length
                ? `Tất cả ${data.interestedEvents.length} sự kiện quan tâm`
                : `${filteredEvents.length} / ${data.interestedEvents.length} sự kiện`}
            </h2>
          </div>
        </div>
      </div>
