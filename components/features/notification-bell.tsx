...
import { NotificationListSkeleton } from "@/components/shared/skeleton";
...
export const NotificationBell = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-3 z-50 card card-compact w-80 md:w-96 bg-base-100 shadow-2xl border border-base-300">
              ...
              {!notifications ? (
                ...
                notifications.map((n) => (
                  <div
                    ...
                    className={`p-4 border-b border-base-200 hover:bg-base-200 cursor-pointer transition-colors ${
