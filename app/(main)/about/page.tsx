    ...
    <div className="space-y-16">
      ...
      <section className="max-w-3xl mx-auto">
        <div className="space-y-4 text-base-content/80 leading-relaxed">
          <p>
            VolunteerHub được ra đời từ mong muốn tạo ra một không gian kết nối
            giữa những người có chung niềm đam mê với hoạt động tình nguyện.
            Chúng tôi nhận thấy rằng nhiều người muốn tham gia các hoạt động
            thiện nguyện nhưng không biết bắt đầu từ đâu, trong khi các tổ chức
            thiện nguyện cũng gặp khó khăn trong việc tìm kiếm và quản lý tình
            nguyện viên.
          </p>
          <p>
            Nền tảng của chúng tôi giúp đơn giản hóa quy trình này, tạo điều
            kiện cho mọi người dễ dàng tìm thấy và tham gia các hoạt động phù
            hợp với sở thích và khả năng của mình, đồng thời giúp các tổ chức
            thiện nguyện tiếp cận được nguồn nhân lực tình nguyện một cách hiệu
            quả.
          </p>
        </div>
      </section>
      ...
      <section className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        <div className="p-8 bg-secondary/5 border border-secondary/20 rounded-lg hover:shadow-md transition-shadow">
          ...
          <p className="text-base-content/70 leading-relaxed">
            Trở thành nền tảng tình nguyện hàng đầu tại Việt Nam, nơi mọi người
            có thể dễ dàng tìm kiếm và tham gia các hoạt động thiện nguyện.
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 bg-base-100 border border-base-300 rounded-lg hover:shadow-md hover:border-primary/30 transition-all">
            ...
            <p className="text-base-content/70">
              Giúp người dùng tìm kiếm và đăng ký tham gia các hoạt động tình
              nguyện phù hợp với sở thích và thời gian của họ.
            </p>
          </div>
          <div className="p-6 bg-base-100 border border-base-300 rounded-lg hover:shadow-md hover:border-secondary/30 transition-all">
            ...
            <p className="text-base-content/70">
              Cung cấp công cụ để các tổ chức thiện nguyện dễ dàng đăng tải,
              quản lý sự kiện và tìm kiếm tình nguyện viên.
            </p>
          </div>
          <div className="p-6 bg-base-100 border border-base-300 rounded-lg hover:shadow-md hover:border-accent/30 transition-all">
            ...
            <p className="text-base-content/70">
              Tạo không gian giao lưu, chia sẻ kinh nghiệm giữa các tình nguyện
              viên và tổ chức.
            </p>
          </div>
          <div className="p-6 bg-base-100 border border-base-300 rounded-lg hover:shadow-md hover:border-info/30 transition-all">
            <h3 className="text-lg font-semibold mb-3 text-info">
              Theo dõi đóng góp
            </h3>
            <p className="text-base-content/70">
              Giúp người dùng theo dõi lịch sử tham gia và những đóng góp của
              mình cho cộng đồng.
            </p>
          </div>
        </div>
      ...
      {status === "unauthenticated" && (
        <section className="text-center space-y-6 py-8">
          ...
          <p className="text-base-content/70 max-w-xl mx-auto">
            Tham gia cùng chúng tôi để tạo ra những thay đổi tích cực cho cộng
            đồng.
          </p>
