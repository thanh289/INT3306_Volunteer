...
function ResetPasswordForm() {
  ...
  useEffect(() => {
    if (!token) {
      toast.error(
        "Đường dẫn không hợp lệ hoặc đã hết hạn. Vui lòng yêu cầu link mới."
      );
        ...
        <div className="alert text-sm mt-4">
          <div className="text-xs">
            ...
            <ul className="space-y-1">
              <li
                className={formData.password.length >= 8 ? "text-success" : ""}
              >
                {formData.password.length >= 8 ? "✓" : "○"} Ít nhất 8 ký tự
              </li>
              <li
                className={
                  PASSWORD_RULES.hasUppercase.test(formData.password)
                    ? "text-success"
                    : ""
                }
              >
              ...
              <li
                className={
                  PASSWORD_RULES.hasLowercase.test(formData.password)
                    ? "text-success"
                    : ""
                }
              >
              ...
              <li
                className={
                  PASSWORD_RULES.hasNumber.test(formData.password)
                    ? "text-success"
                    : ""
                }
              >
              ...
              <li
                className={
                  PASSWORD_RULES.hasSpecial.test(formData.password)
                    ? "text-success"
                    : ""
                }
              >
